...
from Recommenders.Utils.PoolWithSubprocess import PoolWithSubprocess
...
def read_data_split_and_search():
    ...
    collaborative_algorithm_list = [
        ...
        #P3alphaRecommender,
        #RP3betaRecommender,
        Item_based_CF_recommender,
        User_based_CF_recommender,
    ...
    #EDITED URM_validation
    evaluator_validation = SequentialEvaluator(URM_test, cutoff_list=[5])
